(function() {
  ...
  angular.module("cmd.home").controller("LecturerDashboardController", LecturerDashboardController);
  ...
  function LecturerDashboardController(
    ...
    function getFeedbackProgression(guild) {
      var current_week =
        ...
        Math.floor(moment.duration(moment(guild.start).add(guild.course_duration, "weeks") - moment()).asWeeks());
