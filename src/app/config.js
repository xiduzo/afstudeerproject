  ...
  function config(
    ...
    $translateProvider
      .translations('nl-NL', {
        ...
        JS_VERIFY_TRELLO_ACCOUNT: 'Verifieer trello account om door te kunnen gaan',
        ...
        JS_ARE_YOU_SURE_DELETE_RULE: 'Weet je zeker dat je deze afpsraak wilt verwijderen?',
